...
| UNK-010 | ما علاقة Care بـ HRP في بيانات الموظفين (Personnel Master واحد أم مستقل)؟ | يمنع ازدواجية Employee entity | فهارس Care-SET (Adding Employee) و**HRP كامل (الجلسة 8)** | **Partially Resolved** | متوسط | **النصف الداخلي محسوم:** Personnel Master يستقبل المرشح المقبول من RQP آلياً ('Details of the candidate who has accepted the offer will be displayed' — PNT §1) — أي أن دورة التوظيف الأصلية تغذي الملف. **يبقى جسر Care الخارجي** — يفحص عند قراءة Care (3 ملفات) |
