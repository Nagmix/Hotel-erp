...
**التالي بالترتيب:** `gate-passes` (GTP 13 ص — **إغلاق الـ17/17**: TSC موثقة داخل POS) ← ثم المراجعة الشاملة (راجع `analysis/00-discovery/analysis-status.md` §نقطة الاستئناف)
